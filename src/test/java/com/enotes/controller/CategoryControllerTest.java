...
public class CategoryControllerTest {
	...
	public void testSaveCategory() {
		...
		Assertions.assertEquals(response.getStatusCodeValue(), HttpStatus.CREATED);
	...
	public void testCategoryNotSaved() {
		...
		Assertions.assertEquals(response.getStatusCodeValue(), HttpStatus.INTERNAL_SERVER_ERROR);
		Assertions.assertEquals(json.get("success"), "failed");
