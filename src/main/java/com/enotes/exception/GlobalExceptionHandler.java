...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> handleException(Exception e){
		...
		return CommonUtil.createdErrorResponseMessage(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
	}
	...
	public ResponseEntity<?> handleAccessDeniedException(Exception e){
		...
		return CommonUtil.createdErrorResponseMessage(e.getMessage(), HttpStatus.FORBIDDEN);
	}
	...
	public ResponseEntity<?> handleSuccessException(SuccessException e){
		...
		return CommonUtil.createdBuildResponseMessage(e.getMessage(), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> handleIllegalArgumentException(Exception e){
		...
		return CommonUtil.createdErrorResponseMessage(e.getMessage(), HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<?> handleResourceNotFoundException(Exception e){
		...
		return CommonUtil.createdErrorResponseMessage(e.getMessage(), HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<?> handleValidationException(ValidationException e){
		...
		return CommonUtil.createdErrorResponse(e.getErrors(), HttpStatus.BAD_REQUEST);
	}
	
	@ExceptionHandler(FileNotFoundException.class)
	public ResponseEntity<?> handleFileNotFoundException(FileNotFoundException e){
		log.error("GlobalExceptionHandler : handleFileNotFoundException() : {}", e.getMessage());
		return CommonUtil.createdErrorResponse(e.getMessage(), HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<?> handleBadCredentialsException(BadCredentialsException e){
		...
		return CommonUtil.createdErrorResponse(e.getMessage(), HttpStatus.BAD_REQUEST);
	}
