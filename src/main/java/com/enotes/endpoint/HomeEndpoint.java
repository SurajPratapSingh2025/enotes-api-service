...
public interface HomeEndpoint {
	...
	@Operation(summary="Verification user account",tags= {"Home"},description="User Account verfication after register account")
	@GetMapping("/verify")
	public ResponseEntity<?> verifyUserAccount(@RequestParam Integer uid,@RequestParam String code) throws Exception;
	
	@Operation(summary="Save Email for Password Reset",tags= {"Home"},description="User can send Email for password reset")
